...
// Source: github.com/Yogksai/simplebank/db/sqlc (interfaces: Store)
...
// DeleteAсcount mocks base method.
func (m *MockStore) DeleteAсcount(arg0 context.Context, arg1 int64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteAсcount", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteAсcount indicates an expected call of DeleteAсcount.
func (mr *MockStoreMockRecorder) DeleteAсcount(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteAсcount", reflect.TypeOf((*MockStore)(nil).DeleteAсcount), arg0, arg1)
}
